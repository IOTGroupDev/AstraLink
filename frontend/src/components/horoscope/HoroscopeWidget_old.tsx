// frontend/src/components/HoroscopeWidget_old.tsx (исправленная версия)
...
const HoroscopeWidget_old: React.FC<HoroscopeWidgetProps> = ({
...
export default HoroscopeWidget_old;
