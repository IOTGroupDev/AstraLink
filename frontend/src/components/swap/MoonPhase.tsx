...
//   moon-phase: number; // 0-1 (0 = new moon, 0.5 = full moon, 1 = new moon)
//   size?: number;
// }
//
// const MoonPhase: React.FC<MoonPhaseProps> = ({ moon-phase, size = 60 }) => {
...
//   }));
//
//   const getMoonPath = (moon-phase: number) => {
...
//       const crescentWidth = moon-phase * 2 * radius;
...
//       const crescentWidth = (1 - moon-phase) * 2 * radius;
