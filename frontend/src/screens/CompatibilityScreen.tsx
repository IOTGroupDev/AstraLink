...
const copyByLocale = (language: string): Copy => {
  ...
  if (lang.startsWith('en')) {
    return {
      ...
      upgradeBody: 'Compatibility reports are available with Premium.',
  ...
  if (lang.startsWith('es')) {
    return {
      ...
      upgradeBody: 'Los informes están disponibles con Premium.',
  ...
  return {
    ...
    upgradeBody: 'Отчеты совместимости доступны на Premium.',
