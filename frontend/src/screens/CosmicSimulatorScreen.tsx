    ...
    <TabScreenLayout>
      <Animated.View style={[styles.container, animatedStyle]}>
        ...
        >
          ...
          <BlurView intensity={20} tint="dark" style={styles.headerContainer}>
            <View style={styles.headerTop}>
              ...
              <View style={styles.headerTextContainer}>
                <Text style={styles.headerTitle}>{t('cosmicSimulator.header.title')}</Text>
                <Text style={styles.headerSubtitle}>
                  {currentDate.toLocaleDateString(t('cosmicSimulator.header.dateFormat'), {
                    day: 'numeric',
                    month: 'long',
                    year: 'numeric',
                  })}
            ...
            <View style={styles.quickActions}>
              ...
              >
                ...
                <Text style={styles.quickButtonText}>{t('cosmicSimulator.quickActions.minusSevenDays')}</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                style={styles.quickButton}
              >
                <Text style={styles.quickButtonText}>{t('cosmicSimulator.quickActions.minusOneDay')}</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                style={styles.quickButton}
              >
                <Text style={styles.quickButtonText}>{t('cosmicSimulator.quickActions.plusOneDay')}</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                style={styles.quickButton}
              >
                <Text style={styles.quickButtonText}>{t('cosmicSimulator.quickActions.plusSevenDays')}</Text>
            ...
            <BlurView intensity={10} tint="dark" style={styles.dailyLessonCard}>
              <View style={styles.dailyLessonHeader}>
                ...
                <View style={styles.dailyLessonContent}>
                  <Text style={styles.dailyLessonLabel}>{t('cosmicSimulator.dailyLesson.label')}</Text>
              ...
              >
                <Text style={styles.dailyLessonButtonText}>{t('cosmicSimulator.dailyLesson.button')}</Text>
                    ...
                    {isActive ? (
                      ...
                      <>
                        <Ionicons
                          ...
                          color="rgba(255,255,255,0.5)"
                        />
                        <Text style={styles.tabText}>{t(`cosmicSimulator.tabs.${tab}`)}</Text>
                      </>
                    )}
                  </TouchableOpacity>
                );
                ...
                >
                  ...
                  {!hasAIAccess && (
                    <TouchableOpacity style={styles.upgradeButton}>
                      ...
                      >
                        <Text style={styles.upgradeText}>{t('cosmicSimulator.ai.upgradeButton')}</Text>
                        <Ionicons
                          name="arrow-forward"
                          size={16}
                          color="#FFFFFF"
              ...
              <BlurView intensity={10} tint="dark" style={styles.contentCard}>
                <View style={styles.contentHeader}>
                  <View style={styles.contentTitleContainer}>
                    <Text style={styles.contentTitle}>{t('cosmicSimulator.transits.title')}</Text>
                            ...
                            >
                              ...
                              <Text style={styles.learnMoreText}>
                                {t('cosmicSimulator.transits.learnMore', {
                                  aspect: t(`common.aspects.${transit.aspect}`) || aspectRu[transit.aspect],
                                })}
                              </Text>
                            </TouchableOpacity>
                          )}
          ...
          {activeTab === 'planets' && (
            <BlurView intensity={10} tint="dark" style={styles.contentCard}>
              <Text style={styles.contentTitle}>{t('cosmicSimulator.planets.title')}</Text>
          ...
          {activeTab === 'timeline' && (
            <BlurView intensity={10} tint="dark" style={styles.contentCard}>
              <View style={styles.contentHeader}>
                <Text style={styles.contentTitle}>{t('cosmicSimulator.timeline.title')}</Text>
                <TouchableOpacity
              ...
              {historicalNotes.length === 0 ? (
                <View style={styles.emptyNotes}>
                  <Ionicons
                    ...
                    color="rgba(255,255,255,0.3)"
                  />
                  <Text style={styles.emptyNotesText}>{t('cosmicSimulator.timeline.empty')}</Text>
                </View>
              ) : (
                  ...
                  {historicalNotes.map((note, index) => (
                    <View key={index} style={styles.noteItem}>
                      <Text style={styles.noteDate}>
                        {new Date(note.date).toLocaleDateString(t('cosmicSimulator.header.dateFormat'))}
                      </Text>
                      <Text style={styles.noteText}>{note.note}</Text>
                      {note.transits.length > 0 && (
                        <Text style={styles.noteTransits}>
                          {t('cosmicSimulator.timeline.transitsLabel')}{note.transits.join(', ')}
                        </Text>
                      )}
                    </View>
                  ))}
          ...
          {activeTab === 'lessons' && (
            <View style={styles.lessonsContainer}>
              <BlurView intensity={10} tint="dark" style={styles.lessonsHeader}>
                <View>
                  <Text style={styles.lessonsTitle}>{t('cosmicSimulator.lessons.title')}</Text>
                ...
                return (
                  <View key={category} style={styles.lessonCategory}>
                    <Text style={styles.categoryTitle}>
                      {t(`cosmicSimulator.lessons.categories.${category}`)} ({categoryLessons.length})
                    </Text>
          ...
          <View style={styles.modalOverlay}>
            <BlurView intensity={80} tint="dark" style={styles.modalContent}>
              <View style={styles.modalHeader}>
                <Text style={styles.modalTitle}>{t('cosmicSimulator.modals.addNote.title')}</Text>
              ...
              <View style={styles.modalButtons}>
                ...
                >
                  <Text style={styles.modalCancelText}>{t('cosmicSimulator.modals.addNote.cancel')}</Text>
                </TouchableOpacity>
                ...
                >
                  ...
                  >
                    <Text style={styles.modalSaveText}>{t('cosmicSimulator.modals.addNote.save')}</Text>
                  </LinearGradient>
                </TouchableOpacity>
              </View>
            </BlurView>
                  ...
                  <>
                    ...
                    <View style={styles.detailMeta}>
                      <View style={styles.detailMetaItem}>
                        <Text style={styles.detailMetaLabel}>{t('cosmicSimulator.modals.transitDetail.orb')}</Text>
                        <Text style={styles.detailMetaValue}>
                          {selectedTransit.orb}°
                        </Text>
                      </View>
                      <View style={styles.detailMetaItem}>
                        <Text style={styles.detailMetaLabel}>{t('cosmicSimulator.modals.transitDetail.strength')}</Text>
                        <Text style={styles.detailMetaValue}>
                          {Math.round((selectedTransit.strength || 0) * 100)}%
                        </Text>
                      </View>
                      <View style={styles.detailMetaItem}>
                        <Text style={styles.detailMetaLabel}>{t('cosmicSimulator.modals.transitDetail.type')}</Text>
                        <Text
                          style={[
                        ...
                        >
                          {selectedTransit.type === 'harmonious'
                            ? t('cosmicSimulator.modals.transitDetail.harmonious')
                            : selectedTransit.type === 'challenging'
                              ? t('cosmicSimulator.modals.transitDetail.challenging')
                              : t('cosmicSimulator.modals.transitDetail.neutral')}
                        </Text>
                      </View>
                    </View>
        ...
        >
          <View style={styles.modalOverlay}>
            <BlurView intensity={80} tint="dark" style={styles.datePickerModal}>
              <View style={styles.modalHeader}>
                <Text style={styles.modalTitle}>{t('cosmicSimulator.modals.datePicker.title')}</Text>
              ...
              >
                ...
                >
                  <Text style={styles.datePickerDoneText}>{t('cosmicSimulator.modals.datePicker.done')}</Text>
                </LinearGradient>
              </TouchableOpacity>
            </BlurView>
          </View>
