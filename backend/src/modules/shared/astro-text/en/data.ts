...
export const PLANET_IN_SIGN_EN: Partial<Record<PlanetKey, Partial<Record<Sign, string>>>> = {
  sun: {
    Aries: 'Sun in Aries brings initiative, vitality, and leadership.',
    Taurus: 'Sun in Taurus brings consistency, practicality, and appreciation of comfort.',
    ...
    Capricorn: 'Sun in Capricorn brings responsibility, ambition, and structure.',
  ...
  mercury: {
    ...
    Scorpio: 'Mercury in Scorpio penetrates to the core and speaks with intensity.',
    Sagittarius: 'Mercury in Sagittarius broadens perspectives and philosophical thinking.',
  ...
  saturn: {
    ...
    Sagittarius: 'Saturn in Sagittarius demands responsibility in beliefs and expansion.',
  ...
  pluto: {
    ...
    Sagittarius: 'Pluto in Sagittarius transforms belief systems and expansion.',
...
export const ASCENDANT_EN: Partial<Record<Sign, string>> = {
  ...
  Capricorn: 'Ascendant in Capricorn appears responsible, reserved, and ambitious.',
  Aquarius: 'Ascendant in Aquarius appears original, independent, and friendly.',
...
export const GENERAL_TEMPLATES_EN: Record<PeriodFrame, Record<Tone, string[]>> = {
  'Сегодня': {
    positive: [
...
> = {
  ...
  'Завтра': {
    jupiter: ['tomorrow opens possibilities for', 'tomorrow is good to expand in'],
    saturn: ['tomorrow requires planning for', 'tomorrow organize and systematize'],
  ...
  'На этой неделе': {
    ...
    neutral: ['this week suits steady work on', 'this week consolidates results in'],
  },
  'В этом месяце': {
    jupiter: ['this month opens growth in', 'this month supports strategic initiatives in'],
    saturn: ['this month calls for', 'this month is for discipline in'],
    mars: ['this month adds energy for progress in', 'this month strengthens momentum in'],
    neutral: ['this month favors development of', 'this month improves processes in'],
  },
};
...
> = {
  ...
  trine: {
    mercury: {
      jupiter: 'Mercury trine Jupiter brings clarity, learning, and opportunity.',
    },
    sun: {
  ...
  square: {
    mars: {
      saturn: 'Mars square Saturn demands patience, discipline, and structured action.',
    },
    moon: {
      mars: 'Moon square Mars tests emotional control—mind impulses.',
    },
    saturn: {
      uranus: 'Saturn square Uranus clashes stability with change—balance required.',
    },
  },
  opposition: {
    moon: {
      neptune: 'Moon opposite Neptune blurs feelings—seek grounding and clarity.',
    },
    sun: {
  ...
  sextile: {
    mercury: {
      venus: 'Mercury sextile Venus smooths conversations and creative collaboration.',
    },
    neptune: {
...
export const ASCENDANT_META_EN: Partial<Record<Sign, {
  keywords: string[];
  strengths: string[];
  challenges: string[];
}>> = {
  ...
  Libra: {
    ...
    challenges: ['Indecision', 'Dependence on others\' opinions', 'Conflict avoidance'],
  },
  Scorpio: {
