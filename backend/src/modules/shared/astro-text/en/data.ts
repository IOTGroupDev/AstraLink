...
> = {
  sun: {
    ...
    Gemini: ['• Versatile identity across many roles', '• Curiosity fuels learning', '• Communication is core strength', '• Risk: scattered focus', '• Skill: depth over breadth', '• Outcome: intelligent expression'],
    Cancer: ['• Identity rooted in emotional security', '• Intuition guides decisions', '• Nurturing others feels natural', '• Risk: over-attachment', '• Skill: healthy boundaries', '• Outcome: emotional wisdom'],
    Leo: ['• Creative self-expression central', '• Leadership through authenticity', '• Generosity of spirit', '• Risk: need for constant validation', '• Skill: humility', '• Outcome: radiant confidence'],
    Virgo: ['• Practical service brings meaning', '• Analytical precision valued', '• Health and improvement focus', '• Risk: perfectionism', '• Skill: acceptance', '• Outcome: useful mastery'],
    Libra: ['• Identity through relationships', '• Balance and harmony sought', '• Aesthetic appreciation strong', '• Risk: losing self in others', '• Skill: self-assertion', '• Outcome: elegant partnership'],
    Scorpio: ['• Intensity and depth define', '• Transformation is constant', '• Emotional power immense', '• Risk: control issues', '• Skill: vulnerability', '• Outcome: profound authenticity'],
    Sagittarius: ['• Philosophy and adventure drive', '• Truth-seeking essential', '• Optimism naturally present', '• Risk: overextension', '• Skill: grounding', '• Outcome: wise inspiration'],
    Capricorn: ['• Achievement through discipline', '• Long-term goals matter', '• Authority earned', '• Risk: coldness', '• Skill: warmth', '• Outcome: mature leadership'],
    Aquarius: ['• Unique individuality celebrated', '• Innovation excites', '• Collective vision held', '• Risk: emotional detachment', '• Skill: intimacy', '• Outcome: revolutionary insight'],
    Pisces: ['• Spiritual sensitivity profound', '• Compassion boundless', '• Artistic expression natural', '• Risk: escapism', '• Skill: boundaries', '• Outcome: transcendent wisdom'],
  },
  moon: {
    Aries: [
    ...
    Gemini: ['• Emotional processing through talking', '• Mood shifts with mental stimulation', '• Curiosity about feelings', '• Risk: intellectualizing emotions', '• Skill: feeling without analyzing', '• Outcome: emotional intelligence'],
    Cancer: ['• Deep emotional sensitivity', '• Intuition highly attuned', '• Nurturing instinct strong', '• Risk: emotional overwhelm', '• Skill: self-care boundaries', '• Outcome: emotional mastery'],
    Leo: ['• Emotions expressed dramatically', '• Need for emotional recognition', '• Warmth and generosity natural', '• Risk: ego in feelings', '• Skill: emotional humility', '• Outcome: radiant emotional authenticity'],
    Virgo: ['• Emotions analyzed and organized', '• Service eases emotional stress', '• Perfectionism in self-care', '• Risk: over-criticism of feelings', '• Skill: accepting imperfect emotions', '• Outcome: practical emotional wisdom'],
    Libra: ['• Emotions balanced through relationships', '• Harmony sought in feelings', '• Discomfort with conflict', '• Risk: suppressing true emotions', '• Skill: emotional honesty', '• Outcome: balanced emotional expression'],
    Scorpio: ['• Emotions intensely felt', '• Deep transformation through feeling', '• Loyalty in emotional bonds', '• Risk: emotional manipulation', '• Skill: emotional vulnerability', '• Outcome: profound emotional depth'],
    Sagittarius: ['• Emotions optimistic and expansive', '• Philosophy helps process feelings', '• Freedom in emotional expression', '• Risk: avoiding deep emotions', '• Skill: emotional presence', '• Outcome: inspired emotional wisdom'],
    Capricorn: ['• Emotions controlled and structured', '• Responsibility in emotional expression', '• Time helps process feelings', '• Risk: emotional coldness', '• Skill: emotional warmth', '• Outcome: mature emotional strength'],
    Aquarius: ['• Emotions detached and analyzed', '• Unique emotional expression', '• Collective feelings matter', '• Risk: emotional disconnection', '• Skill: personal emotional intimacy', '• Outcome: innovative emotional awareness'],
    Pisces: ['• Emotions boundless and mystical', '• Empathy without limits', '• Artistic emotional expression', '• Risk: emotional overwhelm', '• Skill: emotional boundaries', '• Outcome: transcendent emotional wisdom'],
  },
  mercury: { Aries: ['• Quick thinking', '• Direct communication', '• Instant decisions', '• Debate as process', '• Risk: speaking before thinking', '• Brevity valued', '• Active learning', '• Practice: pause', '• Messages without filters', '• Sporty mind', '• Outcome: bold communication'], Taurus: ['• Deliberate thinking', '• Practical communication', '• Thoughtful decisions', '• Words have value', '• Risk: stubbornness', '• Sensory learning', '• Calm voice', '• Practice: openness', '• Steady concentration', '• Strong memory', '• Outcome: reliable communication'], Gemini: ['• Flexible mind', '• Versatile communication', '• Insatiable curiosity', '• Connecting ideas', '• Risk: scattered attention', '• Social learning', '• Fluent expression', '• Practice: depth', '• Fast processing', '• Clever humor', '• Outcome: vibrant communication'], Cancer: ['• Intuitive thinking', '• Empathic communication', '• Emotional memory', '• Protective words', '• Risk: subjectivity', '• Safe learning', '• Sincere voice', '• Practice: objectivity', '• Feelings inform', '• Internal writing', '• Outcome: nurturing communication'], Leo: ['• Creative thinking', '• Expressive communication', '• Confident ideas', '• Personal narrative', '• Risk: ego', '• Natural oratory', '• Generous knowledge', '• Practice: listening', '• Memorable presentations', '• Stories captivate', '• Outcome: radiant expression'], Virgo: ['• Analytical thinking', '• Detailed communication', '• Keen observation', '• Information organization', '• Risk: criticism', '• Methodical learning', '• Breaking down complexity', '• Practice: accepting imperfection', '• Practical solutions', '• Clear writing', '• Outcome: precise communication'], Libra: ['• Balanced thinking', '• Harmonious communication', '• Multiple perspectives', '• Words build bridges', '• Risk: indecisiveness', '• Collaborative learning', '• Verbal mediation', '• Practice: firmness', '• Aesthetic writing', '• Balanced arguments', '• Outcome: elegant communication'], Scorpio: ['• Deep thinking', '• Intense communication', '• Uncompromising truth', '• Words with power', '• Risk: manipulation', '• Thorough research', '• Perceiving unspoken', '• Practice: vulnerability', '• Profound writing', '• Silence speaks too', '• Outcome: magnetic communication'], Sagittarius: ['• Expansive thinking', '• Optimistic communication', '• Big ideas', '• Truth without tact', '• Risk: exaggeration', '• Teaching calling', '• Humor in messaging', '• Practice: attention to detail', '• Inspiring words', '• Brutal honesty', '• Outcome: inspiring communication'], Capricorn: ['• Strategic thinking', '• Professional communication', '• Targeted information', '• Measured words', '• Risk: coldness', '• Applied learning', '• Authority through competence', '• Practice: warmth', '• Time for processing', '• Concise writing', '• Outcome: mature expression'], Aquarius: ['• Original thinking', '• Unique communication', '• Revolutionary ideas', '• Non-standard perspectives', '• Risk: detachment', '• Technology in expression', '• Accessible concepts', '• Practice: emotional connection', '• Innovation methods', '• Intellectual freedom', '• Outcome: revolutionary communication'], Pisces: ['• Intuitive thinking', '• Poetic communication', '• Understanding through feeling', '• Words create atmosphere', '• Risk: vagueness', '• Artistic expression', '• Empathy in listening', '• Practice: concreteness', '• Metaphors illuminate', '• Mystical writing', '• Outcome: transcendent communication'] },
  venus: { Aries: ['• Direct love', '• Instant attraction', '• Active conquest', '• Independence valued', '• Risk: impatience', '• Spontaneity', '• Practice: patience', '• Desire clearly expressed', '• Electrifying beginning', '• Outcome: bold love'], Taurus: ['• Stable love', '• Tangible attraction', '• Physical pleasure', '• Loyalty essential', '• Risk: possessiveness', '• Slow building', '• Practice: openness', '• Comfort creates connection', '• Long-term commitment', '• Outcome: solid love'], Gemini: ['• Intellectual love', '• Attraction to mind', '• Variety sustains', '• Communication as love', '• Risk: superficiality', '• Endless curiosity', '• Practice: depth', '• Words express', '• Friendship first', '• Outcome: lively love'], Cancer: ['• Nurturing love', '• Attraction to security', '• Home as center', '• Mutual care', '• Risk: dependency', '• Deep intimacy', '• Practice: boundaries', '• Cooking as love', '• Family valued', '• Outcome: warm love'], Leo: ['• Generous love', '• Attraction to confidence', '• Dramatic romance', '• Mutual admiration', '• Risk: need for attention', '• Generous expression', '• Practice: receiving', '• Grand gestures', '• Fun', '• Outcome: radiant love'], Virgo: ['• Practical love', '• Attraction to competence', '• Service demonstrates', '• Mutual improvement', '• Risk: criticism', '• Details matter', '• Practice: acceptance', '• Help as language', '• Routines create closeness', '• Outcome: useful love'], Libra: ['• Balanced love', '• Attraction to beauty', '• Partnership ideal', '• Equality', '• Risk: losing self', '• Aesthetics important', '• Practice: maintaining identity', '• Refined romance', '• Shared decisions', '• Outcome: elegant love'], Scorpio: ['• Intense love', '• Magnetic attraction', '• Deep intimacy', '• Absolute loyalty', '• Risk: jealousy', '• Vulnerability as act', '• Practice: trust', '• Mystery', '• All or nothing', '• Outcome: powerful love'], Sagittarius: ['• Free love', '• Attraction to independence', '• Shared exploration', '• Philosophy unites', '• Risk: avoiding commitment', '• Brutal honesty', '• Practice: presence', '• Humor enlivens', '• Freedom', '• Outcome: expansive love'], Capricorn: ['• Mature love', '• Attraction to stability', '• Building future', '• Mutual respect', '• Risk: coldness', '• Time builds', '• Practice: tenderness', '• Shared goals', '• Loyalty proven', '• Outcome: solid love'], Aquarius: ['• Unique love', '• Attraction to originality', '• Friendship base', '• Independence preserved', '• Risk: detachment', '• Freedom', '• Practice: emotional closeness', '• Innovation', '• Equality', '• Outcome: free love'], Pisces: ['• Mystical love', '• Attraction to sensitivity', '• Emotional merging', '• Boundless empathy', '• Risk: losing boundaries', '• Romance nourishes', '• Practice: boundaries', '• Art connects', '• Unconditional love', '• Outcome: transcendent love'] },
  mars: { Aries: ['• Direct action', '• Abundant energy', '• Competitive leadership', '• Risk: aggression', '• Courage', '• Practice: pause', '• Sports channel', '• Outcome: bold action'], Taurus: ['• Steady action', '• Long-term energy', '• Persistence', '• Risk: inertia', '• Strategic patience', '• Practice: adaptability', '• Constant rhythm', '• Outcome: effective action'], Gemini: ['• Multiple actions', '• Mental energy', '• Dexterity', '• Risk: dispersion', '• Adaptability', '• Practice: focus', '• Communication weapon', '• Outcome: versatile action'], Cancer: ['• Protective action', '• Emotional energy', '• Tenacity', '• Risk: passive aggression', '• Intuition leads', '• Practice: assertiveness', '• Home defended', '• Outcome: cautious action'], Leo: ['• Dramatic action', '• Creative energy', '• Charismatic leadership', '• Risk: ego', '• Generosity', '• Practice: humility', '• Courage', '• Outcome: radiant action'], Virgo: ['• Precise action', '• Service energy', '• Analysis before movement', '• Risk: paralysis', '• Improvement', '• Practice: imperfect action', '• Detailed work', '• Outcome: useful action'], Libra: ['• Balanced action', '• Collaborative energy', '• Thoughtful decision', '• Risk: indecisiveness', '• Partnership strengthens', '• Practice: action without consensus', '• Justice motivates', '• Outcome: elegant action'], Scorpio: ['• Intense action', '• Transforming energy', '• Ruthless determination', '• Risk: revenge', '• Research before attack', '• Practice: forgiveness', '• Deep penetration', '• Outcome: transforming action'], Sagittarius: ['• Expansive action', '• Adventurous energy', '• Optimism', '• Risk: overestimation', '• Philosophy leads', '• Practice: realism', '• Exploration', '• Outcome: inspiring action'], Capricorn: ['• Strategic action', '• Achievement energy', '• Ambition', '• Risk: coldness', '• Authority earned', '• Practice: celebrating', '• Long-term goals', '• Outcome: mature action'], Aquarius: ['• Innovative action', '• Collective energy', '• Independence', '• Risk: rebellion without cause', '• Originality', '• Practice: emotional connection', '• Technology tool', '• Outcome: revolutionary action'], Pisces: ['• Flowing action', '• Spiritual energy', '• Compassion leads', '• Risk: dispersion', '• Sacrifice for greater', '• Practice: boundaries', '• Intuition', '• Outcome: transcendent action'] },
  jupiter: { Aries: ['• Bold expansion', '• Optimism', '• Self-confidence', '• Risk: arrogance', '• Lucky beginnings', '• Outcome: rapid growth'], Taurus: ['• Material expansion', '• Abundance', '• Faith in resources', '• Risk: excess', '• Lucky investments', '• Outcome: prosperity'], Gemini: ['• Intellectual expansion', '• Communication opportunities', '• Faith in connections', '• Risk: dispersion', '• Wide network', '• Outcome: intellectual growth'], Cancer: ['• Emotional expansion', '• Home abundance', '• Faith in intuition', '• Risk: overprotection', '• Family blessed', '• Outcome: emotional growth'], Leo: ['• Creative expansion', '• Expression abundance', '• Faith in greatness', '• Risk: grandiosity', '• Generosity', '• Outcome: radiant growth'], Virgo: ['• Expansion through service', '• Health abundance', '• Faith in improvement', '• Risk: perfectionism', '• Service gives opportunities', '• Outcome: useful growth'], Libra: ['• Expansion through relationships', '• Partnership abundance', '• Faith in balance', '• Risk: dependency', '• Harmony', '• Outcome: harmonious growth'], Scorpio: ['• Expansion through transformation', '• Depth abundance', '• Faith in power', '• Risk: intensity', '• Hidden resources', '• Outcome: deep growth'], Sagittarius: ['• Natural expansion', '• Adventure abundance', '• Higher faith', '• Risk: excess', '• Lucky travels', '• Outcome: expansive growth'], Capricorn: ['• Structured expansion', '• Abundance through work', '• Faith in work', '• Risk: ambition', '• Long-term success', '• Outcome: mature growth'], Aquarius: ['• Expansion through innovation', '• Community abundance', '• Faith in future', '• Risk: rebellion', '• Friendship', '• Outcome: revolutionary growth'], Pisces: ['• Spiritual expansion', '• Compassion abundance', '• Mystical faith', '• Risk: escapism', '• Service', '• Outcome: transcendent growth'] },
  saturn: { Aries: ['• Discipline of impulse', '• Responsibility', '• Challenge: frustration', '• Lesson: think before acting', '• Outcome: responsible leadership'], Taurus: ['• Discipline of resources', '• Financial responsibility', '• Challenge: fear of lack', '• Lesson: release attachments', '• Outcome: earned prosperity'], Gemini: ['• Discipline of scattered', '• Communication responsibility', '• Challenge: mental blocks', '• Lesson: depth over breadth', '• Outcome: mature intellect'], Cancer: ['• Emotional discipline', '• Care responsibility', '• Challenge: family wounds', '• Lesson: self-care', '• Outcome: emotional maturity'], Leo: ['• Discipline of ego', '• Leadership responsibility', '• Challenge: lack of recognition', '• Lesson: humility', '• Outcome: mature leadership'], Virgo: ['• Natural discipline', '• Perfection responsibility', '• Challenge: self-criticism', '• Lesson: accepting imperfection', '• Outcome: mastery'], Libra: ['• Discipline of decisions', '• Relationship responsibility', '• Challenge: fear', '• Lesson: own identity', '• Outcome: mature relationships'], Scorpio: ['• Discipline of intensity', '• Power responsibility', '• Challenge: crises', '• Lesson: release control', '• Outcome: transforming power'], Sagittarius: ['• Discipline of optimism', '• Freedom responsibility', '• Challenge: limitation', '• Lesson: depth', '• Outcome: mature wisdom'], Capricorn: ['• Extreme discipline', '• Enhanced responsibility', '• Challenge: early responsibility', '• Lesson: enjoyment', '• Outcome: structural mastery'], Aquarius: ['• Discipline of originality', '• Innovation responsibility', '• Challenge: alienation', '• Lesson: connection', '• Outcome: mature innovation'], Pisces: ['• Discipline of sensitivity', '• Compassion responsibility', '• Challenge: boundaries', '• Lesson: grounding', '• Outcome: mature compassion'] },
  uranus: { Aries: ['• Radical innovation', '• Revolutionary leadership', '• Sudden changes', '• Total freedom'], Taurus: ['• Value revolution', '• Material changes', '• Practical innovation'], Gemini: ['• Mental genius', '• Innovative communication', '• Revolutionary ideas'], Cancer: ['• Emotional revolution', '• Unconventional home', '• Care innovation'], Leo: ['• Revolutionary creativity', '• Unique leadership'], Virgo: ['• Method innovation', '• Unique systems'], Libra: ['• Unique relationships', '• Partnership revolution'], Scorpio: ['• Radical transformation', '• Deep revolution'], Sagittarius: ['• Revolutionary philosophy', '• Extreme freedom'], Capricorn: ['• Structural revolution', '• Authority innovation'], Aquarius: ['• Natural revolution', '• Absolute freedom'], Pisces: ['• Spiritual revolution', '• Mystical innovation'] },
  neptune: { Aries: ['• Inspired action', '• Visionary leadership'], Taurus: ['• Matter spiritualization', '• Mystical values'], Gemini: ['• Inspired communication', '• Intuitive thinking'], Cancer: ['• Infinite empathy', '• Deep intuition'], Leo: ['• Divine creativity', '• Mystical self-expression'], Virgo: ['• Compassionate service', '• Spiritual healing'], Libra: ['• Idealized love', '• Spiritual beauty'], Scorpio: ['• Mystical transformation', '• Spiritual power'], Sagittarius: ['• Spiritual search', '• Mystical faith'], Capricorn: ['• Spiritual structure', '• Inspired authority'], Aquarius: ['• Utopian vision', '• Humanitarian idealism'], Pisces: ['• Pure spirituality', '• Universal compassion'] },
  pluto: { Aries: ['• Identity transformation', '• Personal power', '• Will rebirth'], Taurus: ['• Value transformation', '• Power over resources'], Gemini: ['• Mental transformation', '• Communication power'], Cancer: ['• Emotional transformation', '• Emotion power'], Leo: ['• Ego transformation', '• Creative power'], Virgo: ['• Service transformation', '• Analysis power'], Libra: ['• Relationship transformation', '• Partnership power'], Scorpio: ['• Enhanced transformation', '• Extreme power'], Sagittarius: ['• Philosophical transformation', '• Teaching power'], Capricorn: ['• Structural transformation', '• Authority power'], Aquarius: ['• Revolutionary transformation', '• Innovation power'], Pisces: ['• Spiritual transformation', '• Mystical power'] },
  north_node: { Aries: ['• Destiny: independence', '• Lesson: courage', '• Direction: leadership'], Taurus: ['• Destiny: stability', '• Lesson: self-worth'], Gemini: ['• Destiny: communication', '• Lesson: curiosity'], Cancer: ['• Destiny: care', '• Lesson: vulnerability'], Leo: ['• Destiny: radiance', '• Lesson: self-expression'], Virgo: ['• Destiny: service', '• Lesson: discernment'], Libra: ['• Destiny: harmony', '• Lesson: commitment'], Scorpio: ['• Destiny: transformation', '• Lesson: vulnerability'], Sagittarius: ['• Destiny: truth', '• Lesson: faith'], Capricorn: ['• Destiny: legacy', '• Lesson: responsibility'], Aquarius: ['• Destiny: innovation', '• Lesson: individuality'], Pisces: ['• Destiny: transcendence', '• Lesson: compassion'] },
  south_node: { Aries: ['• Pattern: excessive independence', '• Release: impulsiveness'], Taurus: ['• Pattern: material attachment', '• Release: stubbornness'], Gemini: ['• Pattern: dispersion', '• Release: superficiality'], Cancer: ['• Pattern: dependency', '• Release: overprotection'], Leo: ['• Pattern: need for attention', '• Release: arrogance'], Virgo: ['• Pattern: perfectionism', '• Release: criticism'], Libra: ['• Pattern: relationship dependency', '• Release: indecisiveness'], Scorpio: ['• Pattern: control', '• Release: manipulation'], Sagittarius: ['• Pattern: excess', '• Release: escapism'], Capricorn: ['• Pattern: rigidity', '• Release: coldness'], Aquarius: ['• Pattern: detachment', '• Release: rebellion'], Pisces: ['• Pattern: escapism', '• Release: victimization'] },
  lilith: { Aries: ['• Raw feminine power', '• Fierce independence'], Taurus: ['• Rebellion against materialism', '• Radical self-worth'], Gemini: ['• Power in voice', '• Unfiltered communication'], Cancer: ['• Rebellion against maternal role', '• Emotional power'], Leo: ['• Creative power without apology', '• Radical radiance'], Virgo: ['• Rebellion against perfection', '• Power in imperfection'], Libra: ['• Rebellion against pleasing', '• Power in disagreement'], Scorpio: ['• Extreme sexual power', '• Enhanced rebellion'], Sagittarius: ['• Rebellion against dogma', '• Raw truth'], Capricorn: ['• Rebellion against authority', '• Power without approval'], Aquarius: ['• Radical rebellion', '• Power in difference'], Pisces: ['• Rebellion against victim', '• Power in sensitivity'] },
  chiron: { Aries: ['• Wound: identity', '• Healing: self-assertion', '• Gift: teaching courage'], Taurus: ['• Wound: self-worth', '• Healing: self-acceptance'], Gemini: ['• Wound: communication', '• Gift: teaching voice'], Cancer: ['• Wound: care', '• Healing: self-care'], Leo: ['• Wound: recognition', '• Healing: self-validation'], Virgo: ['• Wound: perfection', '• Gift: teaching service'], Libra: ['• Wound: relationships', '• Healing: own identity'], Scorpio: ['• Wound: trust', '• Healing: vulnerability'], Sagittarius: ['• Wound: meaning', '• Gift: teaching wisdom'], Capricorn: ['• Wound: authority', '• Healing: self-recognition'], Aquarius: ['• Wound: belonging', '• Healing: authenticity'], Pisces: ['• Wound: boundaries', '• Healing: grounding'] },
};
