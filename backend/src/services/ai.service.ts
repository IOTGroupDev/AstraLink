...
СТИЛЬ: пишите как живой астролог-консультант, а не как справочник. Начните с 1-2 образных абзацев синтеза всей карты в духе: «Ваш космический рисунок — это сплав ...». Затем переходите к подробным разделам.
ВАЖНО: каждый ключевой раздел должен быть развернутым абзацем, а не короткой карточкой. Не пишите «Асцендент во Льве придает яркость...» как единственную мысль; раскрывайте, как это ощущается человеком, как это видят другие, в чем дар, риск и задача роста.
...
- В начале раздела про Асцендент обязательно раскройте первое впечатление, манеру входить в контакт, телесную/поведенческую подачу и задачу роста. Формат: 4-7 человеческих предложений, без сухого списка.
