  ...
  async deleteAccount(userId: string): Promise<void> {
    try {
      ...
      await this.prisma.$transaction(async (tx) => {
        ...
        this.logger.log(
          `✅ Удалено натальных карт: ${chartsDeleted.count}`,
        );
        ...
        this.logger.log(
          `✅ Удалено связей: ${connectionsDeleted.count}`,
        );
        ...
        this.logger.log(
          `✅ Удалено совпадений: ${matchesDeleted.count}`,
        );
        ...
        this.logger.log(
          `✅ Удалено подписок: ${subscriptionsDeleted.count}`,
        );
